...
<script>
    $(function () {
        ...
        alert('${currentEmployee.d_num}');
        //$(".selector").val('${currentEmployee.d_num}');
...
<div class="container">
    <form class="form-horizontal" id="myform" action="${pageContext.request.contextPath}/ManageServlet?op=addEmployee" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control" id="e_num" name="e_num" value="${currentEmployee.e_num}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="radio-inline">
                    <label for="">
                        <input type="radio" name="e_gender" ${currentEmployee.e_gender=='男'?'checked':''}>男
                    </label>
                </div>
                <div class="radio-inline">
                    <label for="">
                        <input type="radio" name="e_gender" ${currentEmployee.e_gender=='女'?'checked':''}>女
                    </label>
                </div>
            </div>
        </div>
